...
oarc_linked_chest.picture.layers[1].filename = "__oarc-mod-tmp-fix__/graphics/hr-oarc-linked-chest.png"
...
oarc_linked_power.pictures.layers[1].filename = "__oarc-mod-tmp-fix__/graphics/hr-oarc-electric-pole.png"

data:extend({
    {
        type = "sprite",
        name = "oarc-mod-sprite-40",
        filename = "__oarc-mod-tmp-fix__/icon_40x40.png",
        width = 40,
        height = 40
    },
